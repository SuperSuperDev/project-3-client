...
const albumSchema = new mongoose.Schema({
  ...
  cover: {
    type: String,
    default:
      'https://www.pngkit.com/png/full/20-202815_vinyl-record-png-transparent-vinyl-png.png',
  },
  year: { type: Date },
...
export default [
  {
    ...
    length: 140,
    musicSrc:
      'https://res.cloudinary.com/dvpwosiqu/video/upload/v1621946232/bensound-sunny_xary2k.mp3',
    comments: [],
  },
  {
    name: 'better days',
    ...
    length: 153,
    musicSrc:
      'https://res.cloudinary.com/dvpwosiqu/video/upload/v1621946371/bensound-betterdays_lynk0w.mp3',
    comments: [],
  },
  /* ... */
]
...
If you have problems installing the app, you need to downgrade the version of Node.js you are using.
